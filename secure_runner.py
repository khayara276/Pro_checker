...
def send_signal(message, token, image_url=None, button_url=None):
    ...
    try:
        ...
        tg_session.post(url, data=payload, timeout=30)
...
class SecureMonitor:
    ...
    def run(self):
        ...
        log(f"🚀 Systems Go. Workers: {NUM_WORKERS}. Max Runtime: 5h 50m")
